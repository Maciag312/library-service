...
@Configuration
@EnableJpaRepositories(basePackageClasses = {JpaUserRepositoryImpl.class}, considerNestedRepositories = true)
@EntityScan(basePackageClasses = {JpaUserRepositoryImpl.class})
